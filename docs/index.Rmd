...
gp_yearly_populations <- gp_populations %>%
  mutate(year = (date %/% 10000)-1) %>% # The choice was made to use population data from January of the next year to represent the entire year more accurately. Therefore 1 must be subtracted.
  filter(sex == "All") %>%
