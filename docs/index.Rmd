...
This project aims to look at trends in the prescribing of dry eye disease (DED) medication across different seasons in Scotland.
...
Moving forward I would like to find ways to be more keywords to detect DED medications.

I would like to include data from several years instead of just 2024.

Then, I would like to look specifically at the seasons and see if there are links to other conditions through medication such as allergy medications that may be causing dry eyes.

Additionally looking at the link to geographical location through health-boards could be interesting, and looking deeper into the links with air quality in cities vs more rural towns as well as trends in different climates and humidities across Scotland's healthboards.
